  ...
  return (
    <div className="relative group border border-cyan-700 p-6 cursor-pointer">
      ...
      <button
        ...
        className="px-5 w-full py-2 rounded-none bg-black text-white font-bold text-lg mt-5"
      >
        View Details
      </button>
      <button
        ...
        className="disabled:opacity-65 px-5 w-full py-2 rounded-none bg-black text-white font-bold text-lg mt-5"
      >
        Add To Cart
      </button>
    </div>
